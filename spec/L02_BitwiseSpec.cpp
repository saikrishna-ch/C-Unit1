...
namespace spec
{
	...
	public:
		...
		void Test_isOdd()
		{
			Assert::AreEqual(0x0, isOdd(2), L"isOdd(2) failed", 1, 2);
			Assert::AreEqual(0x0, isOdd(4534), L"isOdd(4534) failed", 1, 2);
			Assert::AreEqual(0x1, isOdd(2341), L"isOdd(2341) failed", 1, 2);
			Assert::AreEqual(0x1, isOdd(689), L"isOdd(689) failed", 1, 2);
		};
